...
### Захват ресурсов (Resource Hijacking)
...
### Социальная инженерия и подмена контента (Social Engineering & Content Tampering)
...
### Риск для цепочки поставок программного обеспечения (Software Supply Chain Risk)
